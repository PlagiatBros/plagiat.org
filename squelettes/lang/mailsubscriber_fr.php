...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'confirmsubscribe_invite_texte_email_liste_1' => '@invite_email_from@ vous invite à vous inscrire à la liste « @titre_liste@ » de @nom_site_spip@ avec l’adresse email @email@.',
...
@url_confirmsubscribe@',
	...
	'confirmsubscribe_texte_email_liste_1' => 'Vous avez demandé à vous inscrire à la liste « @titre_liste@ » de @nom_site_spip@ avec l’adresse email @email@.',
	'confirmsubscribe_titre_email' => 'Confirmation d’inscription à la Newsletter',
	'confirmsubscribe_titre_email_liste' => 'Confirmation d’inscription à la liste « <b>@titre_liste@</b> »',
	...
	// E
	'erreur_adresse_existante' => 'Cette adresse email est déjà dans la liste de diffusion',
	'erreur_adresse_existante_editer' => 'Cette adresse email est déjà enregistrée - <a href="@url@">Editer cet utilisateur</a>',
	'erreur_technique_subscribe' => 'Une erreur technique a empêché ton inscription.',
	...
	// S
	'subscribe_deja_texte' => 'L’adresse email @email@ est déjà inscrite.',
	'subscribe_sujet_email' => '[@nom_site_spip@] Inscription à la Newsletter',
	'subscribe_texte_email_1' => 'L’adresse email @email@ est maintenant dans la liste de diffusion.',
...
@url_unsubscribe@',
	...
	// U
	'unsubscribe_deja_texte' => 'L’adresse email @email@ n’est pas dans la liste de diffusion.',
	'unsubscribe_sujet_email' => '[@nom_site_spip@] Désinscription de la Newsletter',
	'unsubscribe_texte_confirmer_email_1' => 'Confirmer la désinscription de l’adresse email @email@ en cliquant sur le bouton : ',
	'unsubscribe_texte_confirmer_email_liste_1' => 'Confirmer la désinscription de l’adresse email @email@ de la liste <b>@titre_liste@</b> en cliquant sur le bouton : ',
